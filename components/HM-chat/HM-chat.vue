		...
		methods:{
			...
			transMsg(msg) {
				if (msg.type == "TIMTextElem"){
					...
					let content = this.setPicSize(
						{
							url:msg.payload.imageInfoArray[1].url,
							w:msg.payload.imageInfoArray[1].width,
							h:msg.payload.imageInfoArray[1].height
						}
					);
					return({
						type:"user",
						msg:{
							...
							userinfo:{
								uid:msg.flow=='in'?1:0,
								username:msg.from,face:msg.avatar
							},
							content,
						},
					})
